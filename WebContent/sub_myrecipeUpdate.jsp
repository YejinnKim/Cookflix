...
<%
	...
	content.myrecipe myrecipe = new myrecipeDAO().getmyrecipe(no);
%>
<header>
	...
	<div align="center">
	<form method="post" action="sub_myrecipeUpdateAct.jsp">
	<input type="hidden" name="No" value="<%= no %>">
		<table width="800" border="3" bordercolor="lightgray" align="center">
        <tr>
            <td>작성자</td>
            <td><%=myrecipe.getUsername() %></td>
        </tr>
            <tr>
            <td>
                제 목
        ...
        <tr>
            ...
            <td>
                <textarea  cols="100" rows="20"name="content" id="ir1"><%=myrecipe.getContent() %></textarea>            
            </td>        
        </tr>
